...
### Хранение данных
Если остановить контейнеры и заново запустить, все изменения, сделанные до остановкм, не сохранятся. Для хранения данных исполюзуются волюмы. Так как внесенные изменения хранятя в БД, создадим волюм для контейнера **mongo:latest**:
```console
